                ...
                if (res[0] *(other.x - this.x) + res[1] * (other.y - this.y) >= 0 ) {
                    ...
                    if ((this.type == 'player') || (other.type == 'player')){
                      if ((this.type == 'enemy') || (other.type == 'enemy')){
                        ...
                        console.log('[. PLAYER <-<_Collided_>-> ENEMY .] =>> -10hp [both]');
                      }
                      if ((this.type == 'bullet') || (other.type == 'bullet')){
                        this.hp = this.hp - 20;
                        other.hp = other.hp - 20;
                        console.log('[. PLAYER <-<_Collided_>-> BULLET .] =>> -20hp [both]');
                      }
                      if ((this.type == 'heal') || (other.type == 'heal')){
                        this.hp = this.hp + 20;
                        other.hp = other.hp - 20;
                        console.log('[. PLAYER <-<_Collided_>-> HEAL .] =>> +20hp [PLAYER] >> -20hp [HEAL]');
                      }
                    }
                    ...
                    if ((this.type == 'enemy') || (other.type == 'enemy')){
                      if ((this.type == 'bullet') || (other.type == 'bullet')){
                        this.hp = this.hp - 20;
                        other.hp = other.hp - 20;
                        console.log('[. ENEMY <-<_Collided_>-> BULLET .] =>> -20hp [both]');
                      }
                    }
                    ...
                    if (other.hp < 0){
                      other.hp = 0;
                      console.log(other.type + ' has died!')
                    }
...
function getEnemyStartNumber(){
	var helperNumber = (typeof enemyNum === 'undefined') ? enemyNum : 0;
	return helperNumber;
}
var enemiesAliveNumber = 0;

function mainLoop(mapObjs, canvas, ctx) {
		if (enemiesAliveNumber != -1){
  		enemiesAliveNumber = 0;
		}
    ...
    if(newObj2 != null){
      ...
      mapObjs.push(newObj2);
		...
		if ((enemiesAliveNumber != -1) && (mapObjs.length > 0) && (enemiesAliveNumber == 0)){
