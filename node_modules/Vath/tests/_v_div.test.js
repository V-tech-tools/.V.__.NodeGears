...
const v_div_tests = [{
        ...
        expected: "ERROR: Missing Params vath.v_div(x,y)"
    },
    {
...
for (let itemIndex in v_div_tests) {
    let item = v_div_tests[itemIndex];
...
if (printAll) {
    console.log('/================================================================\\');
    console.log('| PRINTING OBJECT [ v_div_tests ]                                |')
    console.log('+----------------------------------------------------------------+')
    console.log(v_div_tests);
    console.log('+----------------------------------------------------------------+')
    console.log('| END OF OBJECT [ v_div_tests ]                                  |')
    console.log("\\===============================================================/")
}

var numberOfIgnored = 0;

v_div_tests.forEach(item => {
    if (item.pass === false) {
...
console.log("")
console.log('Testing Results [ vath.v_div() ]:')
console.log("-> Number of tests: [ "+ v_div_tests.length +" ]");
console.log("-> Passing Tests Number: [ "+ (v_div_tests.length - (v_test_res.length + numberOfIgnored)) +" ]");
...
const v_test_res_div = v_test_res;
