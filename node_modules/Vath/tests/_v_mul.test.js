...
const v_mul_tests = [{
        ...
        expected: "ERROR: Missing Params vath.v_mul(x,y)"
    },
    {
...
for (let itemIndex in v_mul_tests) {
    let item = v_mul_tests[itemIndex];
...
if (printAll) {
    console.log('/================================================================\\');
    console.log('| PRINTING OBJECT [ v_mul_tests ]                                |')
    console.log('+----------------------------------------------------------------+')
    console.log(v_mul_tests);
    console.log('+----------------------------------------------------------------+')
    console.log('| END OF OBJECT [ v_mul_tests ]                                  |')
    console.log("\\===============================================================/")
}

var numberOfIgnored = 0;

v_mul_tests.forEach(item => {
    if (item.pass === false) {
...
console.log("")
console.log('Testing Results [ vath.v_mul() ]:')
console.log("-> Number of tests: [ "+ v_mul_tests.length +" ]");
console.log("-> Passing Tests Number: [ "+ (v_mul_tests.length - (v_test_res.length + numberOfIgnored)) +" ]");
...
const v_test_res_mul = v_test_res;
